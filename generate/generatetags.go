...
var (
	outputFilename   = flag.String("output_filename", "/tmp/dict.go", "file to output tags")
...
func readDataElementFromRow(s []string) dataElementTag {
	...
	if len(s) < 5 {
		log.Fatalf("Missing required data elements for row: %v", s)
	}

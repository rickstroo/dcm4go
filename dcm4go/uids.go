...
const (
	...
	// JPEG2000ImageCompressionLosslessOnly is transfer syntax uid for JPEG 2000 image compression (lossless only)
	...
	JPEG2000ImageCompressUID = "1.2.840.10008.1.2.4.91"
